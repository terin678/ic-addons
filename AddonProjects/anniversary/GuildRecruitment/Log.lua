...
-- Shared with the UI and with chat, so a kind keeps one colour everywhere, and
-- one meaning: green happened, amber waiting or derived, red failed, grey noted.
Log.KIND_COLOR = {
...
positional version stops being readable, and the third one always arrives.
    opts = { kind = "sent", source = "Bark", since = <timestamp> }
]]
